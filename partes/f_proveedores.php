...
<form id="f_proveedores" class="formularios">
  <h3 class="titulo_form">PROVEEDOR</h3>
    ...
    <div class="campo_form">
    <label class="label_width">Dias de crédito</label>
...
<form id="f_proveedores_contacto" class="formularios">
  ...
  <input type="hidden" name="id_empresa" value="<?php echo $_SESSION["id_empresa"]; ?>" />
    ...
    <div class="campo_form">
	 ...
	 <div class="campo_form">
        <label class="label_width">Servicios que ofrece</label>
        <input type="text" name="servicios" class="servicios">
    </div>
	
	 <div class="campo_form">
	      <label class="label_width">Metodo de pago</label>
	<SELECT NAME="metodopago" class="metodopago" SIZE=1> 
