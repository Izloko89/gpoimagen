  ...
  <div id="hacer">
    ...
    <?php } ?>
        ...
        <div class="campo_form celda fondo_azul" align="center">
        	<label>Grupo</label><input class="eventosalon salonr" id="eventocheck" type="radio" name="quitar" value="salon" checked />
      ...
      <div class="tabla">
        <div class="celda" style=" width:600px;">
          ...
          <div class="campo_form">
		    ...
		    <div class="campo_form">
            <label style="width:120px;">Nombre del Contacto</label>
			<input type="text" id="nombrecontacto" name="nombrecontacto" class="nombrecontacto text_largo"/>
          </div>
          <div class="campo_form">
		  ...
		  <div class="campo_form">
            <label style="width:120px;">Lugar del evento</label>
			<input type="text" name="lugar_evento" id="lugarevento" class="lugar_evento text_largo"/>
          </div>
		  <div class="campo_form">
            <label style="width:120px;">Ciudad</label>
			<input type="text" name="ciudad" id="ciudad" class="ciudad text_largo"/>
          </div>
		  	  <div class="campo_form">
            <label style="width:120px;">Numero de personas</label>
			<input type="text" name="nopersonas" id="nopersonas" class="nopersonas text_largo"/>
          </div>
		</div>
        <div class="celda" style="">
          ...
          <div class="campo_form">
        	...
        	<abbr title=""><input placeholder="Click para elegir" class="fecha alejar_izq requerido fechafinal" id="fechafinal" name="fechafinal" type="text" name="fechadesmont" readonly/></abbr><!--
            --><img class="borrar_fecha" data-class="fechadesmont" src="img/cruz.png" width="15" />
          </div>
		</div>
      </div>
    ...
    <h3 class='titulo_form'>Cuenta</h3>
       <!-- <div class="campo_form">
        ...
        <div class="campo_form">
			...
			<input type="text" class="totalevento numerico" readonly />
        </div>
        <div class="campo_form">
            <label class="">Metodo de pago</label>
            <select class="metodo" id="combo" onChange="verifica()">
			...
			<script>
			function verifica(){
			var palabra = document.getElementById("combo").value;
			if(palabra=="Credito")
			{
            ...
            <div class="divplazos" style="display:none;">
			 ...
			 <div id="divdias" style="display:none;">
			   <label class="">Dias:</label>
			  <input type="text" class="dias" size="" style="height:20px;margin:4px;"  id="dias" name="dias"/>
			 </div>
        ...
        <div class="campo_form">
            ...
            <input type="text" class="restante numerico" readonly />
        </div>
        <div align="right">
 	<a id="imp_cot" href="scripts/pdf_cotizacion.php" target="_blank"></a>
