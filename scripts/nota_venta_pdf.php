...
if(isset($_GET["id_evento"])){
	...
	try{
		...
		$cargocontacto = $evento["cargocontacto"];
		$dirEvento = $evento["dirEvento"];
		$fechaEnvio = $evento["fecha"];
		$responsableseg = $evento["responsableseg"];
...
<tr>
  ...
  <tr>
    ...
    <td style="width:30%;font-size:12px;border-bottom:0.3px solid #000;">'.$nombrecontacto.'</td>
    </tr>
  <tr>
	<td style="width:20%;font-size:12px;"><strong>EMPRESA:</strong></td>
	<td style="width:30%;font-size:12px;border-bottom:0.3px solid #000;">'.$cliente.'</td>
  </tr>
   <tr>
    <td style="width:20%; font-size:12px;"><strong>CARGO:</strong></td>
    <td style="width:30%;font-size:12px;border-bottom:0.3px solid #000;">'.$cargocontacto.'</td>
    </tr>
   <tr>
    <td style="width:20%;font-size:12px;"><strong>TELEFONOS:</strong></td>
    <td style="width:30%;font-size:12x;border-bottom:0.3px solid #000;">'.$telefonocontacto.'</td>
  </tr>
  <tr>
    <td style="width:20%;font-size:12px;"><strong>DIRECCION:</strong></td>
    <td style="width:30%;font-size:12px;border-bottom:0.3px solid #000;">'.$dirEvento.'</td>
  </tr>
</table>
<br/>
...
<tr>
      ...
      <td style="width:50%; text-align:left;font-size:10px;">'.$responsableseg.'</td>
    </tr>
    <tr>
      <td style="width:50%; text-align:left;font-size:12px;"><strong>FECHA SOLICITUD DE SERVICIO</strong></td>
      <td style="width:50%;text-aling:left;font-size:10px;">'.$fechaEnvio.'</td>
    </tr>
    <tr>
