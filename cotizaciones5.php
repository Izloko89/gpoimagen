  ...
  <div id="hacer">
    ...
    <?php } ?>
        ...
        <div class="campo_form celda fondo_azul" align="center">
        	<label>Salon</label><input class="eventosalon salonr" id="eventocheck" type="radio" name="quitar" value="salon" checked />
        ...
        <div class="campo_form salones celda" style="width:292px;">
			...
			<select name="salon" id="salon" class="salon">
            	<option selected disabled>Elige un Salon</option>
            	<?php salonesOpt();	?>
            </select>
		</div>
        ...
        <div class="celda" style=" width:600px;">
          ...
          <div class="campo_form">
		   ...
		   <div class="campo_form">
            ...
            <input name="nombrecontacto" class="nombrecontacto text_largo" id="nombrecontacto" type="text" />
          </div>
		    <div class="campo_form">
    ...
    <h3 class='titulo_form'>Cuenta</h3>
        ...
        <div align="right">
        	...
        	<?php 
				if($_SESSION['qwe'][0]['fichacontrol'] == 1)
				{
			?>
              <a id="imp_cot_m" href="scripts/pdf_cotizacion_m.php" target="_blank">Presupuesto autorizado</a><?php }?>
